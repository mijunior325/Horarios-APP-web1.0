...
function Button({ onClick, className, label, disabled, icon }) {
  const baseClass = "text-xl font-bold gap-2 h-30 md:h-30 lg:h-50 w-full shadow-lg border border-gray-300 rounded-lg flex justify-center items-center transition-colors duration-200";
